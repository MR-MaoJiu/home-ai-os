...
TOOLS = [
    ...
    {"type":"function","function":{"name":"create_reminder","description":"在家庭服务器创建提醒，不表示已写入手机系统","parameters":{"type":"object","properties":{"title":{"type":"string"}},"required":["title"],"additionalProperties":False}}},
